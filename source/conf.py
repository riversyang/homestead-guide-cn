...
project = u'以太坊 Homestead 文档'
copyright = u'2016, Ethereum community'
author = u'Ethereum community, Rivers Yang译'
...
latex_documents = [
  (master_doc, 'homesteadguide.tex', u'以太坊 Homestead文档',
   u'Ethereum community, Rivers Yang译', 'manual'),
]
...
man_pages = [
    (master_doc, 'homesteadguide', u'以太坊 Homestead 文档',
     [author], 1)
]
